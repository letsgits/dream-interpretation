# 周公AI解梦 Chrome 扩展 | AI Dream Interpreter | AI夢解釈 | AI몽해석
...
[返回頂部](#周公ai解梦-chrome-扩展--ai-dream-interpreter--ai夢解釈--ai몽해석)
...
[トップに戻る](#周公ai解梦-chrome-扩展--ai-dream-interpreter--ai夢解釈--ai몽해석)
...
[맨 위로](#周公ai解梦-chrome-扩展--ai-dream-interpreter--ai夢解釈--ai몽해석)

---

## 开发者 | Developer | 開發者 | 개발자

- 作者 | Author | 作者 | 작성자：d.y.
- 官网 | Website | ウェブサイト | 웹사이트：[https://www.lingjiai.com](https://www.lingjiai.com)

## 更新日志 | Changelog | 更新履歴 | 업데이트 기록

### 版本 1.0 | Version 1.0 | バージョン1.0 | 버전 1.0
- 首次发布 | Initial release | 初回リリース | 최초 출시
- 支持基本的解梦功能 | Basic dream interpretation | 基本的な夢解釈機能 | 기본 꿈해몽 기능
- 支持多语言 | Multi-language support | 多言語対応 | 다국어 지원
- 支持聊天历史记录 | Chat history | チャット履歴 | 채팅 기록
- 支持清空聊天记录 | Clear chat history | チャット履歴の消去 | 채팅 기록 삭제

## 许可证 | License | ライセンス | 라이선스

Copyright © 2024 灵机AI. All rights reserved. 